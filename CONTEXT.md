...
audited for reads outside it. A forbidden read that succeeds voids the run; one that
was denied is recorded as a breach; any other read off the sandbox is
judged by the maintainer.
