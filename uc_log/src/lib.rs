...
//! The archive agent records it to [`uc_journal`] in CRC'd blocks with one
...
/// name the posture without a direct `uc_journal` dependency.
pub use uc_journal::Durability;
