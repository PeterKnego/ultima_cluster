...
Download the signed `v2.13.0` tarball and run its quickstart — no toolchain
needed:

```bash
tar xzf uc2-2.13.0-x86_64-unknown-linux-gnu.tar.gz
uc2-2.13.0-x86_64-unknown-linux-gnu/packaging/quickstart-local.sh
```
...
- **[Command cheatsheet](/docs/reference/cheatsheet.md)** — every developer
  and operator command, one line each ([printable PDF](/docs/uc-cheatsheet.pdf)).
