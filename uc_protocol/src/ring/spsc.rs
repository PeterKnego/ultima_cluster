...
impl SpscProducer {
    ...
    pub fn try_write(
        ...
        if bytes_to_tail < total {
            ...
            // `slot_offset` to capacity belong to us.
            unsafe {
        ...
        // `[slot_offset, slot_offset + total)` lies entirely within the slot
...
impl SpscConsumer {
    ...
    pub fn try_read(
        ...
        loop {
            ...
            let read = unsafe {
                try_read_record_at(self.inner.slot_region(), slot_offset, payload_buf)
            }?;
