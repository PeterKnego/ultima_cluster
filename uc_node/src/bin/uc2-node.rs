...
use clap::Parser;
use uc_node::config_file::AdminAuthMode;
use uc_node::obs::http::ObsServer;
use uc_node::preflight::FsVerdict;
use uc_node::{AdminKey, AdminPolicy, DrainOutcome, Node, StartOpts, config_file, preflight};
...
fn main() -> ExitCode {
    ...
    uc_node::obs::log::set_level(opts.obs.log_level);
