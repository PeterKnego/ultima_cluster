...
//!
//! ```text
//! cargo run -p uc2_crypto --release --example seal_bench
//! ```
//!
//! ## Why this exists
//!
...
//!
//! ```text
//! cargo run -p uc2_crypto --release --example seal_bench                    # as shipped
//! RUSTFLAGS="--cfg aes_force_soft --cfg polyval_force_soft" \
//!   cargo run -p uc2_crypto --release --example seal_bench                  # forced software
//! ```
//!
...
use uc2_crypto::seal::{open_with, seal_with};
...
fn main() {
    ...
    println!("================= uc2_crypto seal bench (AES-NI check) =================");
