...
**`2.6.x`**: fixes land on the newest patch of the newest minor, and there are
no backports to earlier minors. Versions move in lockstep across every crate,
the tag, the tarballs and the image — see
