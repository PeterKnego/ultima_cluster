...
/// codes 2/3/10 — see `uc_consensus::config::ClusterConfig::reason_code`).
...
/// `publish_peer_band` fix (`uc_node/src/node.rs`): a rebuild that SHRINKS
...
///
/// Root cause (FIXED): `ElectionSm::adopt_config` (`uc_consensus/src/election.rs`)
