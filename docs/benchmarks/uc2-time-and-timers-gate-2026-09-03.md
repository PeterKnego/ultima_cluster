...
| `scripts/apply_ab.sh` B′ resolution, row d's run | not measured on the rig; dev-box smoke 2026-09-07: **0.026 %** at N=1 (worst sem 0.131 %), 0.444 % at N=2 (worst sem 0.695 %) |
