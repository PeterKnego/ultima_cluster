...
//!
//! ```text
//! cargo run -p uc2_node --release --example m7_gate -- all      --secs S
//! cargo run -p uc2_node --release --example m7_gate -- node     --id N --bind A --members … --instance-dir D
//! cargo run -p uc2_node --release --example m7_gate -- service  --instance-dir D
//! cargo run -p uc2_node --release --example m7_gate -- probe    --instance-dir D
//! cargo run -p uc2_node --release --example m7_gate -- loadclient --instance-dir D
//! ```
//!
...
//! says (`uc2_node/tests/reconfig.rs::joining_node_boots_from_stale_seed`
...
// ------------------------------------------------------------ admin helpers
//
// Same shape as `uc2ctl`/`uc2_node/tests/reconfig.rs`'s admin-slot flow: write
