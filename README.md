...
Download the signed `v2.12.0` tarball and run its quickstart — no toolchain
needed:

```bash
tar xzf uc2-2.12.0-x86_64-unknown-linux-gnu.tar.gz
uc2-2.12.0-x86_64-unknown-linux-gnu/packaging/quickstart-local.sh
```
